...
<template>
	...
	>
		...
		>
			...
			<div>
				<div class="flex items-center">
					...
					<span class="ml-2 text-lg text-gray-500 font-medium">{{
				...
				<div class="flex items-center">
					<div class="flex-grow text-base text-gray-500 font-medium">
			...
			>
				<svg
					class="w-10 h-10 text-red-400 hover:text-red-600 ml-2"
					viewBox="0 0 24 24"
				>
					<path
						fill="currentColor"
		...
		<div class="flex justify-center">
			<div
				class="inline-flex items-center justify-center text-base font-medium px-2.5 py-1 bg-white border border-gray-200 rounded-full my-5"
			>
				{{ today() }}
			</div>
		</div>
		...
		>
			...
			>
				<svg
					...
					:class="message_old.status == 0 ? 'text-gray-400' : 'text-green-400'"
					viewBox="0 0 12 12"
				>
					<path
						d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z"
			...
			<div>
				<div class="flex items-center">
					...
					<div class="ml-2 text-lg text-gray-500 font-medium">
